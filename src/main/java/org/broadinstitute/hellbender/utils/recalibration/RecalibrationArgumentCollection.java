...
public final class RecalibrationArgumentCollection implements Serializable {
     ...
     */
    @Argument(fullName = "maximum-cycle-value", shortName = "maxCycle", doc = "The maximum cycle value permitted for the Cycle covariate", optional = true)
     ...
     */
    @Argument(fullName = "mismatches-default-quality", shortName = "mdq", doc = "default quality for the base mismatches covariate", optional = true)
     ...
     */
    @Argument(fullName = "insertions-default-quality", shortName = "idq", doc = "default quality for the base insertions covariate", optional = true)
     ...
     */
    @Argument(fullName = "deletions-default-quality", shortName = "ddq", doc = "default quality for the base deletions covariate", optional = true)
     ...
     */
    @Argument(fullName = "low-quality-tail", shortName = "lqt", doc = "minimum quality for the bases in the tail of the reads to be considered", optional = true)
     ...
     */
    @Argument(fullName = "quantizing-levels", shortName = "ql", optional = true, doc = "number of distinct quality scores in the quantized output")
    public int QUANTIZING_LEVELS = 16;

    /**
     * The tag name for the binary tag covariate (if using it)
     */
    @Argument(fullName = "binary-tag-name", shortName = "bintag", optional = true, doc = "the binary tag covariate name if using it")
    public String BINARY_TAG_NAME = null;

    @Argument(fullName = "bqsr-baq-gap-open-penalty", shortName="BAQGOP", doc="BQSR BAQ gap open penalty (Phred Scaled).  Default value is 40.  30 is perhaps better for whole genome call sets", optional = true)
     ...
     */
    @Argument(fullName = "preserve-qscores-less-than", shortName = "PQ", doc = "Don't recalibrate bases with quality scores less than this threshold (with -" + StandardArgumentDefinitions.BQSR_TABLE_SHORT_NAME + ")", optional = true)
    public int PRESERVE_QSCORES_LESS_THAN = QualityUtils.MIN_USABLE_Q_SCORE;

    @Hidden
    @Argument(fullName = "enable-baq", shortName = "BAQ", doc = "do BAQ correction")
    public boolean enableBAQ = false;

    @Hidden
    @Argument(fullName = "compute-indel-bqsr-tables", shortName = "indel", doc = "compute indel BQSR tables")
    ...
    @Argument(fullName="default-base-qualities", shortName = "DBQ", doc = "Assign a default base quality", optional = true)
    ...
    @Hidden
    @Argument(fullName = "default-platform", shortName = "dP", optional = true, doc = "If a read has no platform then default to the provided String. Valid options are illumina, 454, and solid.")
    public String DEFAULT_PLATFORM = null;

    @Hidden
    @Argument(fullName = "force-platform", shortName = "fP", optional = true, doc = "If provided, the platform of EVERY read will be forced to be the provided String. Valid options are illumina, 454, and solid.")
