 ...
 * consecutive position and adds it to a set. By default, the set is stored in a hash table file.</p>
 *
 * <p>Users also have the option to represent the k-mers set using a <a href="https://en.wikipedia.org/wiki/Bloom_filter">Bloom
 * filter</a>. This uses less memory than the default hash set but also can produce false positives. In other words, when
