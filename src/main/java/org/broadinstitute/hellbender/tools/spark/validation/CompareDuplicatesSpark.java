...
public final class CompareDuplicatesSpark extends GATKSparkTool {
    ...
    public static final String PRINT_SUMMARY_SHORT_NAME = "ps";
    public static final String THROW_ON_DIFF_LONG_NAME = "throw-on-diff";
    public static final String THROW_ON_DIFF_SHORT_NAME = "cd";
    ...
    @Argument(doc="Print a summary", shortName = PRINT_SUMMARY_SHORT_NAME, fullName = PRINT_SUMMARY_LONG_NAME, optional = true)
    protected boolean printSummary = true;

    @Argument(doc="Throw error if any differences were found", shortName = THROW_ON_DIFF_SHORT_NAME, fullName = THROW_ON_DIFF_LONG_NAME, optional = true)
