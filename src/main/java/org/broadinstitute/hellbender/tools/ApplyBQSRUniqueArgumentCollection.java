...
public class ApplyBQSRUniqueArgumentCollection implements Serializable {
     ...
     */
    @Argument(fullName="quantize-quals", shortName = "QQ", doc = "Quantize quality scores to a given number of levels", optional=true)
     ...
     */
    @Advanced
    @Argument(fullName="static-quantized-quals", shortName = "SQQ", doc = "Use static quantized quality scores to a given number of levels (with -"+ StandardArgumentDefinitions.BQSR_TABLE_SHORT_NAME+ ")", optional=true, mutex = "quantize-quals")
     ...
     */
    @Advanced
    @Argument(fullName="round-down-quantized", shortName = "RDQ", doc = "Round quals down to nearest quantized qual", optional=true, mutex = "quantize-quals")
     ...
     */
    @Argument(fullName="emit-original-quals", shortName = "EOQ", doc = "Emit original base qualities under the OQ tag", optional=true)
     ...
     */
    @Argument(fullName = "global-qscore-prior", shortName = "GQ", doc = "Global Qscore Bayesian prior to use for BQSR", optional = true)
